...
--
-- Host: 127.0.0.1
-- Generation Time: 21 Jan 2016 pada 12.54
...
(20, 'meja', 'meja makan jepang', 'gambarbrg/meja/meja7.jpg', 600000, 250000, 35),
...
(25, 2, 'belum', 765000, 405000, 360000, 'fix', NULL),
...
(29, 3, 'belum', 1350000, 540000, 810000, 'fix', '2016-01-21');
...
(19, 3, 28, 1, 'belum', '2016-01-20', 'belum');
...
--
ALTER TABLE `pelunasan`
  MODIFY `id_pelunasan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
