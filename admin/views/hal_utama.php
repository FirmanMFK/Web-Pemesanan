...
<html lang="en">
  ...
  <body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Halaman Utama Admin
                            </li>
                        </ol>
                    </div>
                </div>
  ...
  <center>
    <div id="page-wrapper">
      <div class="jumbotron">
        <img width="900px" src="../../customer/gambarbrg/slide/bg4.jpg">
          <p>Lakukan pengelolaan pemesanan dengan baik dan benar</p>
      </div>
    </div>
  </center>
